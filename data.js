 ...
 */
export const PSWD_REGEX =
  /^(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?=.*[!@#$%^&*]).{8,}$/

export const PSW_REGEX_2 =
  /^(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.*[!@#$%^&*])(?=.{8,})/

export const LANDING_URL = '/'
// export const LANDING_URL = 'https://mysweetdreams.es'
export const IMAGES_URL = 'https://msdstoragearc.blob.core.windows.net/user-pfp/'
// const API_URL = 'http://localhost:3000'
const API_URL = 'https://msd-api-arc.azurewebsites.net/'
